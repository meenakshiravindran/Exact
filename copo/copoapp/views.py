...
class DepartmentView(APIView): 
    def get(self,request):
        ...
        department_data = [
            {"dept_id": dept.dept_id, "dept_name": dept.dept_name} for dept in departments
        ]
...
def get_levels(request):
    try:
        ...
        levels_data = [
            {"level_id": level.level_id, "level_name": level.name}
            for level in levels
        ]
...
def get_faculty(request):
    try:
        ...
        faculty_data = [
            {"faculty_id": faculty.faculty_id, "name": faculty.name} for faculty in faculty_list
        ]
...
def get_courses(request):
    try:
        ...
        course_data = [
            {"course_id": course.course_id, "course_code": course.course_code} for course in course_list
        ]
...
def add_batch(request):
    if request.method == "POST":
        ...
        try:
            ...
            course = Course.objects.get(course_id=data["course"]) if data["course"] else None
